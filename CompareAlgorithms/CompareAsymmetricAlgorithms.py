...
class AsymmetricAlgorithmComparator():
    ...
    def measure_performance(self, algo, data):
        ...
        return performance_helper.measure_performance(algo, data,1)
    ...
    def compare_algorithms(self,data,key_space):
        ...
        # Frequency analysis
        algo1_encrypted = self.algo1(data)[0]
        algo2_encrypted = self.algo2(data)[0]
